...
/** Maps {@link InvalidAccountTypeException} to a 400 RFC 7807 Problem Details response. */
@Provider
public final class InvalidAccountTypeExceptionMapper
    implements ExceptionMapper<InvalidAccountTypeException> {
